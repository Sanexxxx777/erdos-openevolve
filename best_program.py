...
class Hyperparameters:
    ...
    num_steps: int = 20000
    penalty_strength: float = 10000.0 # Further reduced penalty strength to allow better objective-constraint balance
...
class ErdosOptimizer:
    ...
    def run_optimization(self):
        ...
        for step in range(self.hypers.num_steps): # Removed tqdm for simplification
